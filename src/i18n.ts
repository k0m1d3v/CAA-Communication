...
const messages = {
  ...
  en: {
    ...
    ascoltaTrovaPage: {
      subtitle: 'Listen to the word and find the matching pictogram',
      welcomeTitle: 'Welcome to Listen & Find!',
      welcomeDescription:
        'Listen carefully to the word, then tap the pictogram that matches it. Great practice for listening skills!',
      startButton: 'Start Playing',
      score: 'Score',
      loading: 'Loading new word...',
      listenAgain: 'Listen again',
      speaking: 'Speaking…',
      optionAriaLabel: 'Pictogram option',
      correct: 'Correct! Well done!',
      incorrect: 'Not quite — the word was "{word}"',
      skipButton: 'Skip',
      quitButton: 'Quit Game',
      noDataFound: 'No data found. Please try again.',
      loadError: 'Error loading word. Please try again.',
    },
    memoryPage: {
      subtitle: 'Find the matching pairs of pictograms',
      welcomeTitle: 'Welcome to Memory!',
      welcomeDescription:
        'Flip two cards at a time to find matching pairs. A good exercise for visual memory!',
      startButton: 'Start Playing',
      moves: 'Moves',
      loading: 'Preparing the board...',
      loadError: 'Could not load the game. Please try again.',
      hiddenCardAriaLabel: 'Hidden pictogram card',
      wonTitle: 'You won!',
      wonDescription: 'You found all the pairs in {moves} moves.',
    ...
    accessibility: {
      ...
      sizeExtraLarge: 'Extra-large text',
      ...
      fineAdjustments: 'Fine-tuning',
      presets: {
        visualImpairment: 'I see poorly',
        motorImpairment: 'Moving is hard for me',
        cognitiveSupport: 'I want fewer things on screen',
      },
  ...
  it: {
    common: {
      ...
      educationalProject: 'Progetto Educativo IIS Volta Lodi',
      freeToUse: 'Gratuito per sempre',
      home: 'Home',
      removePictogram: 'Togli',
    ...
    ascoltaTrovaPage: {
      subtitle: 'Ascolta la parola e trova il pittogramma giusto',
      welcomeTitle: 'Benvenuto in Ascolta e Trova!',
      welcomeDescription:
        'Ascolta con attenzione la parola, poi tocca il pittogramma corrispondente. Ottimo esercizio per l\'ascolto!',
      startButton: 'Inizia a Giocare',
      score: 'Punteggio',
      loading: 'Caricamento nuova parola...',
      listenAgain: 'Ascolta di nuovo',
      speaking: 'Sto parlando…',
      optionAriaLabel: 'Opzione pittogramma',
      correct: 'Corretto! Bravo!',
      incorrect: 'Non proprio — la parola era "{word}"',
      skipButton: 'Salta',
      quitButton: 'Esci dal Gioco',
      noDataFound: 'Nessun dato trovato. Riprova.',
      loadError: 'Errore nel caricamento della parola. Riprova.',
    },
    memoryPage: {
      subtitle: 'Trova le coppie di pittogrammi uguali',
      welcomeTitle: 'Benvenuto in Memory!',
      welcomeDescription:
        'Gira due carte alla volta per trovare le coppie uguali. Un buon esercizio per la memoria visiva!',
      startButton: 'Inizia a Giocare',
      moves: 'Mosse',
      loading: 'Preparazione del tabellone...',
      loadError: 'Impossibile caricare il gioco. Riprova.',
      hiddenCardAriaLabel: 'Carta pittogramma nascosta',
      wonTitle: 'Hai vinto!',
      wonDescription: 'Hai trovato tutte le coppie in {moves} mosse.',
    ...
    accessibility: {
      ...
      sizeMedium: 'Testo medio',
      sizeLarge: 'Testo grande',
      sizeExtraLarge: 'Testo molto grande',
      highContrast: 'Modalità Alto Contrasto',
      reducedMotion: 'Riduci Animazioni',
      colorBlindFriendly: 'Palette per daltonici',
      simplifiedUI: 'Interfaccia semplificata',
      gestureNavigation: 'Navigazione gestuale',
      eyeTrackingMode: 'Modalità eye tracking',
      textToSpeech: 'Sintesi Vocale',
      voiceSpeed: 'Velocità voce',
      fineAdjustments: 'Regolazioni fini',
      presets: {
        visualImpairment: 'Vedo poco',
        motorImpairment: 'Mi muovo con difficoltà',
        cognitiveSupport: 'Voglio meno cose sullo schermo',
      },
